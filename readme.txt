...
With this plugin you make it possible for your visitors to scroll and navigate your website by talking to the browser. This plugin is mostly for fun since it only works in Google Chrome at the moment (supporting -webkit-speech)

== Description ==

This Wordpress plugin makes it possible for your visitors to scroll and navigate your website by talking to the browser (english only). The idea is to give people with **disabilities** (that makes it difficult or impossible to use a mouse) a better website experience.
